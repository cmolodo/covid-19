...
The Locations & Demographics page used as source for reported daily/total cases and deaths appears to have an issue on 2021-04-20 - although it claims that the data was updated, the numbers are all identical to the values from 2021-04-19.  Filled in missing 2021-04-02 values by interpolating.
